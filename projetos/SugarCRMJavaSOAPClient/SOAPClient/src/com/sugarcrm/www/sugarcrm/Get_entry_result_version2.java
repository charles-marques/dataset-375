...
public class Get_entry_result_version2  implements java.io.Serializable {
    ...
    private com.sugarcrm.www.sugarcrm.Link_name_value[][] relationship_list;
    ...
    public Get_entry_result_version2(
           ...
           com.sugarcrm.www.sugarcrm.Link_name_value[][] relationship_list) {
     ...
     */
    public com.sugarcrm.www.sugarcrm.Link_name_value[][] getRelationship_list() {
        return relationship_list;
    }
     ...
     */
    public void setRelationship_list(com.sugarcrm.www.sugarcrm.Link_name_value[][] relationship_list) {
        this.relationship_list = relationship_list;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.sugarcrm.com/sugarcrm", "link_list"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
