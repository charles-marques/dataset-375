...
public class Link_name_value  implements java.io.Serializable {
    ...
    private com.sugarcrm.www.sugarcrm.Name_value[][] records;
    ...
    public Link_name_value(
           ...
           com.sugarcrm.www.sugarcrm.Name_value[][] records) {
           this.name = name;
     ...
     * @return records
     */
    public com.sugarcrm.www.sugarcrm.Name_value[][] getRecords() {
        return records;
    }
     ...
     * @param records
     */
    public void setRecords(com.sugarcrm.www.sugarcrm.Name_value[][] records) {
        this.records = records;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.sugarcrm.com/sugarcrm", "link_value"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
