...
public class Return_search_result  implements java.io.Serializable {
    private com.sugarcrm.www.sugarcrm.Link_name_value[] entry_list;

    public Return_search_result() {
    }

    public Return_search_result(
           com.sugarcrm.www.sugarcrm.Link_name_value[] entry_list) {
     ...
     * @return entry_list
     */
    public com.sugarcrm.www.sugarcrm.Link_name_value[] getEntry_list() {
        return entry_list;
    }
     ...
     * @param entry_list
     */
    public void setEntry_list(com.sugarcrm.www.sugarcrm.Link_name_value[] entry_list) {
        this.entry_list = entry_list;
    }
