...
public final class PDF {
  ...
  public static boolean leistungsuebersicht(final Database datenbank, final String email){
    final List<String> liste=datenbank.getLeistungsuebersichtPDF(email);
   ...
   */
    ...
    final List<String> liste=datenbank.getKurslistePDF(email);
   ...
   */
    public static boolean teilnehmerliste(final Database datenbank, final String kursid){
      final List<String> liste=datenbank.getTeilnehmerlistePDF(kursid);
      final String kurs=datenbank.getVeranstaltungsTitel(kursid);
