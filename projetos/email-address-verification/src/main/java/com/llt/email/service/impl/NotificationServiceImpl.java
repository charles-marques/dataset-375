...
public class NotificationServiceImpl implements NotificationService {
    ...
    @Override
    public void send(String fromEmail, String toEmail, String subject, Map<String, Object> attributes,
        String templateName) {
        try {
            ...
            message.setText(FreeMarkerTemplateUtils.processTemplateIntoString(
                freemarkerConfiguration.getTemplate(templateName), attributes));
