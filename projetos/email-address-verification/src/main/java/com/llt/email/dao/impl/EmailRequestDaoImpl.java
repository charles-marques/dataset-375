...
public class EmailRequestDaoImpl extends BaseDaoImpl implements EmailRequestDao {
    ...
    @Override
    public int insert(EmailRequest request) {
        NamedParameterJdbcTemplate jdbcTemplate = new NamedParameterJdbcTemplate(dataSource);

        String sqlText = getSQL(SQL_INSERT_REQUEST);

        return jdbcTemplate.update(sqlText, new BeanPropertySqlParameterSource(request));
    }
    ...
    public void update(Integer requestId, Status status, String validEmailAddress) {
        ...
        MapSqlParameterSource namedParameters = new MapSqlParameterSource("requestId", requestId);
    ...
    public List<EmailRequest> findInvalidEmailRequests(Date cutOffDate) {
        ...
        MapSqlParameterSource namedParameters = new MapSqlParameterSource("cutOffDate", cutOffDate);
    ...
    private class ResulRowHandler implements RowCallbackHandler {
        ...
        public void processRow(ResultSet rs) throws SQLException {
            EmailRequest request = resultBeanHandler.handle(rs, EmailRequest.class);
            results.add(request);
        }
    }
