...
import com.instapaper.util.ConfigurationHashtable;
import com.instapaper.util.Logger;
import com.instapaper.util.Queue;
...
public class PersistentEventStore implements EventStore
{
    ...
    private static final long       STOREHASH    = 0xbebc95b35c17aa70L; // com.google.blackberry.apps.analytics.PersistentEventStore.Instapaper
